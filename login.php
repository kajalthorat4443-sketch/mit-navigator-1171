...
<head>
    ...
    <title>MIT NEVIGATOR - Login</title>
    ...
    <style>
        ...
        .ambient-mesh {
            ...
            background-image: 
                radial-gradient(at 20% 20%, hsla(172, 66%, 41%, 0.15) 0, transparent 50%), 
                radial-gradient(at 80% 80%, hsla(222, 47%, 11%, 1) 0, transparent 50%);
        }
...
<body class="ambient-mesh min-h-screen flex flex-col justify-center items-center p-6 relative overflow-hidden">
    ...
    <!-- Decorative Elements -->
    <div class="absolute top-1/4 left-1/4 w-96 h-96 bg-teal-500/10 rounded-full blur-3xl mix-blend-screen pointer-events-none"></div>
    <div class="absolute bottom-1/4 right-1/4 w-96 h-96 bg-blue-500/10 rounded-full blur-3xl mix-blend-screen pointer-events-none"></div>
    ...
    <div class="auth-container rounded-3xl p-10 w-full max-w-md relative z-10">
        ...
        <div class="text-center mb-8">
            ...
            <h2 class="text-3xl font-bold text-white tracking-tight">Access Portal</h2>
            <p class="text-slate-400 mt-2 text-sm">Authenticate to the MIT NEVIGATOR.</p>
        </div>
        ...
        <form action="api/auth.php?action=login" method="POST" class="space-y-6">
            <div>
                <label for="email" class="block text-sm font-medium text-slate-400 mb-2 uppercase tracking-wide text-xs">Email Identification</label>
                <div class="relative">
            ...
            <div>
                <label for="password" class="block text-sm font-medium text-slate-400 mb-2 uppercase tracking-wide text-xs">Security Key</label>
                <div class="relative">
                    <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
            ...
            <button type="submit" class="teal-glow-btn w-full text-slate-900 font-bold text-base py-4 rounded-xl uppercase tracking-wider h-[56px] flex items-center justify-center">
                Initialize Session <i class="fas fa-arrow-right ml-2 opacity-70"></i>
            </button>
        </form>

        <div class="mt-8 pt-6 border-t border-slate-700/50 text-center space-y-4">
            <p class="text-sm text-slate-400">
                New to MIT NEVIGATOR? 
                <a href="register.php" class="text-teal-400 hover:text-teal-300 font-semibold transition-colors">Establish Profile</a>
            </p>
